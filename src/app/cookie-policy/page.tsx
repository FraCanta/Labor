...
export default function CookiePolicyPage() {
  return (
    <LegalPage title="Cookie Policy">
      ...
      <p>
        Il sito non utilizza cookie pubblicitari, di profilazione o analytics e non installa strumenti di tracciamento per misurare il comportamento degli utenti. Il banner consente di accettare o rifiutare il caricamento di Google Maps.
      </p>
      <p>
      ...
      <h2>5. Modifiche all’informativa</h2>
      <p>
        Questa Cookie Policy sarà aggiornata qualora vengano introdotti analytics, servizi pubblicitari, nuovi contenuti incorporati o altri strumenti di tracciamento.
      </p>
